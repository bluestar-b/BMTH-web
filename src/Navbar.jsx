    ...
    <div className="navbar bg-transparent">
      <div className="navbar-start">
        <div className="dropdown">
          <label
            tabIndex={0}
            className="btn btn-ghost font-bold text-gray-200 lg:hidden"
          >
            <svg
          ...
          <ul
            tabIndex={0}
            className="menu dropdown-content rounded-box menu-sm z-[1] mt-4 w-52 border-2 border-gray-100 bg-black bg-opacity-60 p-2 font-bold text-gray-200 shadow"
          >
